                    ...
                    <div class="order-header">
                        <div class="order-header-items">
                            ...
                            <div>
                                ...
                                <div>{{ presetPrice($order->billing_total) }}</div>
                            </div>
                        </div>
                        <div>
                            <div class="order-header-items">
                    ...
                    <div class="order-products">
                        <table class="table" style="width:50%">
                            <tbody>
                                ...
                                <tr>
                                    <td>Subtotal</td>
                                    <td>{{ presetPrice($order->billing_subtotal) }}</td>
                                </tr>
                                <tr>
                                    <td>Tax</td>
                                    <td>{{ presetPrice($order->billing_tax) }}</td>
                                </tr>
                                <tr>
                                    <td>Total</td>
                                    <td>{{ presetPrice($order->billing_total) }}</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        @foreach ($products as $product)
                            <div class="order-product-item">
                                ...
                                <div>
                                    ...
                                    <div>{{ presetPrice($product->price) }}</div>
