...
class ProductsController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            // insertar si hay almenos una categoria marca nueva marcada
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->has('_validate')) {
            ...
            //Customer
            $this->updateProductCategories($request, "94");
            //endCustomer

            return redirect()
                ->route("voyager.{$dataType->slug}.index")
                ->with([
                        'message'    => __('voyager::generic.successfully_added_new')." {$data->id}",
                        'alert-type' => 'success',
                    ]);
        }
    }
